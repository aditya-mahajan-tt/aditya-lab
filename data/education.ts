 ...
 * fields. Highlight labels were drafted with a review marker and have
 * since been reviewed and approved by Aditya on 2026-09-07 (marker
 * removed). School-level entries (CBSE X/XII) are excluded per Aditya's
...
const raw = [
  {
    ...
    highlights: [{ value: "25%", label: "Pankaj Bansal Scholarship for Young Leaders" }],
  },
  {
    id: "bits-pilani",
    ...
    highlights: [
      { value: "₹40L+", label: "sponsorship raised leading Quark's 100-member outreach team" },
      { value: "1,500+", label: "participants across Zephyr Controls' 20+ events" },
    ],
  },
];
