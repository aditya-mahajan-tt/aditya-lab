        ...
        <div className="container-lab">
          ...
          <ol className="mt-12 divide-y divide-border border-y border-border">
            {about.progression.map((step, i) => (
              <li key={step.label} className="flex flex-col gap-2 py-6 md:flex-row md:gap-10">
          ...
          <div className="prose-lab mt-14 space-y-6 text-[length:var(--text-lg)] text-text-muted">
